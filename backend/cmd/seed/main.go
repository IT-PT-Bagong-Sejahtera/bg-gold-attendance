...
func seed(ctx context.Context, db *sql.DB, email, password string) error {
	...
	rolePermissions := map[string][]string{
		...
		"SUPERVISOR": {"employee.read", "employee.create", "section.read", "section.manage", "policy.read", "shift.read", "shift.manage", "attendance.own", "attendance.read", "attendance.approve", "report.read", "leave.own", "leave.read", "leave.approve", "claim.own", "claim.read", "claim.approve", "announcement.read", "announcement.manage", "notification.own"},
